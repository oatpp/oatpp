...
#undef OATPP_MACRO_API_CONTROLLER_HEADER_0
#undef OATPP_MACRO_API_CONTROLLER_HEADER_1
#undef OATPP_MACRO_API_CONTROLLER_HEADER_CHOOSER
#undef OATPP_MACRO_API_CONTROLLER_HEADER_CHOOSER_EXP
#undef OATPP_MACRO_API_CONTROLLER_HEADER

// __INFO

#undef OATPP_MACRO_API_CONTROLLER_HEADER_INFO_0
#undef OATPP_MACRO_API_CONTROLLER_HEADER_INFO_1
#undef OATPP_MACRO_API_CONTROLLER_HEADER_INFO_CHOOSER
#undef OATPP_MACRO_API_CONTROLLER_HEADER_INFO_CHOOSER_EXP
#undef OATPP_MACRO_API_CONTROLLER_HEADER_INFO

// PATH MACRO // ------------------------------------------------------

#undef OATPP_MACRO_API_CONTROLLER_PATH_0
#undef OATPP_MACRO_API_CONTROLLER_PATH_1
#undef OATPP_MACRO_API_CONTROLLER_PATH_CHOOSER
#undef OATPP_MACRO_API_CONTROLLER_PATH_CHOOSER_EXP
#undef OATPP_MACRO_API_CONTROLLER_PATH

// __INFO

#undef OATPP_MACRO_API_CONTROLLER_PATH_INFO_0
#undef OATPP_MACRO_API_CONTROLLER_PATH_INFO_1
#undef OATPP_MACRO_API_CONTROLLER_PATH_INFO_CHOOSER
...
#undef OATPP_MACRO_API_CONTROLLER_ENDPOINT_
#undef OATPP_MACRO_API_CONTROLLER_ENDPOINT__
#undef OATPP_MACRO_API_CONTROLLER_ENDPOINT___
