...
#define OATPP_MACRO_DB_CLIENT_PARAM_PARAMS_DTO_PUT_DECL(X) \
const OATPP_MACRO_DB_CLIENT_PARAM_TYPE X & OATPP_MACRO_DB_CLIENT_PARAM_NAME X,

#define OATPP_MACRO_DB_CLIENT_PARAM_PARAMS_DTO_PUT_TYPE(X) \
OATPP_MACRO_DB_CLIENT_PARAM_MACRO_TYPE X

#define OATPP_MACRO_DB_CLIENT_PARAM_PARAMS_DTO_PUT_BODY(X) \
OATPP_MACRO_DB_CLIENT_PARAM_MACRO X
...
const oatpp::data::share::StringTemplate Z_QUERY_TEMPLATE_##NAME = \
  m_executor->parseQueryTemplate(#NAME, QUERY_TEXT, {}, false); \
\
...
oatpp::data::share::StringTemplate Z_QUERY_TEMPLATE_CREATOR_##NAME() { \
  ...
  \
  return m_executor->parseQueryTemplate(#NAME, QUERY_TEXT, map, __prepare); \
} \
\
