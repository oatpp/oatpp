...
// PARAMS_DTO MACRO USE-CASE

#undef OATPP_MACRO_DB_CLIENT_PARAM_PARAMS_DTO_PUT_DECL

#undef OATPP_MACRO_DB_CLIENT_PARAM_PARAMS_DTO_PUT_TYPE

#undef OATPP_MACRO_DB_CLIENT_PARAM_PARAMS_DTO_PUT_BODY

// PARAMS_DTO MACRO

#undef OATPP_MACRO_DB_CLIENT_PARAM_PARAMS_DTO_1

#undef OATPP_MACRO_DB_CLIENT_PARAM_PARAMS_DTO_2

#undef OATPP_MACRO_DB_CLIENT_PARAM_PARAMS_DTO

// PARAM_TYPE MACRO

#undef OATPP_MACRO_DB_CLIENT_PARAM_PARAMS_DTO_TYPE_1

#undef OATPP_MACRO_DB_CLIENT_PARAM_PARAMS_DTO_TYPE_2

#undef OATPP_MACRO_DB_CLIENT_PARAM_PARAMS_DTO_TYPE
