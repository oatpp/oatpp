...
class TypeResolver {
private:
  type::BaseObject::PropertyTraverser m_propertyTraverser;
...
public:
   ...
   * @return
   */
  const type::Type* resolveType(const type::Type* type) const;
   ...
   * @return
   */
  type::Void resolveValue(const type::Void& value) const;
   ...
   */
  const type::Type* resolveObjectPropertyType(const type::Type* objectType, const std::vector<std::string>& path) const;
   ...
   */
  type::Void resolveObjectPropertyValue(const type::Void& object, const std::vector<std::string>& path) const;
