...
public:
  ...
  template<>
  oatpp::String convertParameterToString(const oatpp::String& typeName, const oatpp::String& parameter) {
    (void) typeName;
    return parameter;
  }

  template<>
  oatpp::String convertParameterToString(const oatpp::String& typeName, const oatpp::Int8& parameter) {
    (void) typeName;
    if(parameter) {
  ...
  template<>
  oatpp::String convertParameterToString(const oatpp::String& typeName, const oatpp::UInt8& parameter) {
    (void) typeName;
    if(parameter) {
  ...
  template<>
  oatpp::String convertParameterToString(const oatpp::String& typeName, const oatpp::Int16& parameter) {
    (void) typeName;
    if(parameter) {
      return utils::conversion::int32ToStr(parameter->getValue());
    }
  ...
  template<>
  oatpp::String convertParameterToString(const oatpp::String& typeName, const oatpp::UInt16& parameter) {
    (void) typeName;
    if(parameter) {
      return utils::conversion::uint32ToStr(parameter->getValue());
    }
  ...
  template<>
  oatpp::String convertParameterToString(const oatpp::String& typeName, const oatpp::Int32& parameter) {
    (void) typeName;
    if(parameter) {
      return utils::conversion::int32ToStr(parameter->getValue());
    }
  ...
  template<>
  oatpp::String convertParameterToString(const oatpp::String& typeName, const oatpp::UInt32& parameter) {
    (void) typeName;
    if(parameter) {
      return utils::conversion::uint32ToStr(parameter->getValue());
    }
  ...
  template<>
  oatpp::String convertParameterToString(const oatpp::String& typeName, const oatpp::Int64& parameter) {
    (void) typeName;
    if(parameter) {
  ...
  template<>
  oatpp::String convertParameterToString(const oatpp::String& typeName, const oatpp::UInt64& parameter) {
    (void) typeName;
    if(parameter) {
  ...
  template<>
  oatpp::String convertParameterToString(const oatpp::String& typeName, const oatpp::Float32& parameter) {
    (void) typeName;
    if(parameter) {
  ...
  template<>
  oatpp::String convertParameterToString(const oatpp::String& typeName, const oatpp::Float64& parameter) {
    (void) typeName;
    if(parameter) {
  ...
  template<>
  oatpp::String convertParameterToString(const oatpp::String& typeName, const oatpp::Boolean& parameter) {
    (void) typeName;
    if(parameter) {
