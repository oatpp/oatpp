...
private:
  oatpp::data::mapping::type::VariantWrapper m_dto;
  oatpp::data::mapping::ObjectMapper* m_objectMapper;
public:
  DtoBody(const oatpp::data::mapping::type::VariantWrapper& dto,
...
public:
  ...
  static std::shared_ptr<DtoBody> createShared(const oatpp::data::mapping::type::VariantWrapper& dto,
                                         oatpp::data::mapping::ObjectMapper* objectMapper) {
